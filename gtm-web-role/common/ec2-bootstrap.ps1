...
[System.Environment]::SetEnvironmentVariable('DD_TRACE_ANALYTICS_ENABLED', 'true', [System.EnvironmentVariableTarget]::Machine)
...
Start-Service -Name IPEventBuffer
Start-Service -Name ipMonitorService